...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadPromotions() {
        ...
        document.querySelectorAll('.promotion-edit-btn').forEach(btn => {
            btn.addEventListener('click', function() {
        ...
        document.querySelectorAll('.promotion-delete-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const promotionId = this.getAttribute('data-id');
    ...
    function savePromotion() {
        ...
        const selectedProducts = Array.from(document.getElementById('promotion-products').selectedOptions)
